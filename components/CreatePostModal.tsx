        ...
        <div className="p-7">
          {step === 1 ? (
            <div className="space-y-7 flex flex-col items-center">
              <div className="w-24 h-24 bg-brand-primary/5 dark:bg-brand-primary/20 rounded-3xl flex items-center justify-center text-brand-primary dark:text-brand-secondary shadow-inner rotate-3">
              ...
              <div className="grid grid-cols-1 gap-5 w-full">
                <button 
                  ...
                  className="w-full py-5 px-4 bg-brand-primary text-white rounded-[1.5rem] font-bold hover:brightness-110 shadow-lg active:scale-95 transition-all"
                >
                  Upload from Device
                </button>
                ...
                <div className="space-y-4">
                  <textarea
                    ...
                    className="w-full p-5 bg-gray-50 dark:bg-slate-800 dark:text-white border border-gray-100 dark:border-slate-700 rounded-[1.5rem] text-sm h-28 focus:ring-2 focus:ring-brand-primary focus:outline-none transition-all placeholder:text-gray-300 font-medium"
                    value={magicPrompt}
                  ...
                  <button 
                    ...
                    className="w-full py-5 px-4 bg-brand-gradient text-white rounded-[1.5rem] font-bold flex items-center justify-center space-x-2 disabled:opacity-50 shadow-xl hover:brightness-110 active:scale-95 transition-all"
                  >
